...
public class Project implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	 ...
	 */
	public static final java.lang.String entityName = "Expenses.Project";
	 ...
	 */
	public static expenses.proxies.Project initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new expenses.proxies.Project(context, mendixObject);
	}

	public static expenses.proxies.Project load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return expenses.proxies.Project.initialize(context, mendixObject);
	}

	public static java.util.List<expenses.proxies.Project> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> expenses.proxies.Project.initialize(context, obj))
	...
	public boolean equals(Object obj)
	{
		...
		{
			final expenses.proxies.Project that = (expenses.proxies.Project) obj;
