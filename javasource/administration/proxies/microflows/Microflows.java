...
public final class Microflows
{
	...
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Administration.MendixSSO_AfterStartup");
		return builder;
	}
	...
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Administration.MendixSSO_CreateUser");
		builder = builder.withParam("UserProfile", _userProfile);
		builder = builder.withParam("UUID", _uUID);
		return builder;
	}

	public static administration.proxies.Account mendixSSO_CreateUser(
		IContext context,
		mendixsso.proxies.UserProfile _userProfile,
		java.lang.String _uUID
	)
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder mendixSSO_MigrateUsersToAccountBuilder()
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Administration.MendixSSO_MigrateUsersToAccount");
		return builder;
	}

	public static void mendixSSO_MigrateUsersToAccount(IContext context)
	{
		mendixSSO_MigrateUsersToAccountBuilder().execute(context);
	}
	...
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Administration.MendixSSO_UpdateUser");
	...
	public static administration.proxies.Account mendixSSO_UpdateUser(
		IContext context,
		administration.proxies.Account _user,
		mendixsso.proxies.UserProfile _userProfile,
		java.lang.String _uUID
